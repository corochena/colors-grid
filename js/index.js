        ...
        $(".cell").click(function(){
            var color = $('#selColors').val();
            $(this).attr('style','background:' + color);
            $(this).html(color + '<br><span style="color:white;">' + color + '</span>');
        })
...
function loadColors() {
    ...
    for (i=0; i<COLOR_NAMES.length; i++) {
        htmlText += "<option>" + COLOR_NAMES[i] + "</option>";
    }
    document.getElementById("selColors").innerHTML = htmlText;
}